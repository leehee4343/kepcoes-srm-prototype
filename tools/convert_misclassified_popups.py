...
CONVERSIONS = [
    ...
    ("modules/10_기준정보관리/SRMSourcingGroupManage.html", "sgManageModal", "SRMSourcingGroupDetail.html"),
    ...
    ("modules/10_기준정보관리/SRMCommonDocManage.html", "cdFormModal", "SRMCommonDocForm.html"),
